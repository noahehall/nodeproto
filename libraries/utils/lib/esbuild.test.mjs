...
test('esm: can glob import', t => {
  t.deepLooseEqual(Object.keys(wrapper), ['default', 'envproto', 'esproto', 'fsproto']);
});

test('esm: default import', t => {
  t.deepLooseEqual(Object.keys(defaultImport), ['envproto', 'esproto', 'fsproto']);
});

test('ESM: can destructure import', t => {
