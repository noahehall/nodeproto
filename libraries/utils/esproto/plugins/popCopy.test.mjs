...
test.beforeAll(async t => {
  ...
  fstubs.sourcepath = await fsproto.resolve('./fixtures/sourcedir/copytooutdir.mjs', import.meta.url );
})
...
test('fileShouldCopy: returns latest timestamp for updated sourcepath', async t => {
  ...
  // confirm
  t.equal(newmtimems, Number.POSITIVE_INFINITY, 'yes')
})
