...
const getHtmlWebpackPlugin = htmlOptions => Array.isArray(htmlOptions)
  ? htmlOptions.map(o => new HtmlWebpackPlugin({
...
export default function reactDevWebpackConfig({
  ...
  return baseWebpackConfig({
    ...
    pathSrc,
    plugins: [
      entryUnshift.some(e => e.includes('webpack-hot')) ? new webpack.HotModuleReplacementPlugin() : false,
