...
// TODO: instead of a separate file, this should just be a branch off the existing base/setup.webpack.config
// ^ swing back to this once src/esbuild is complete
